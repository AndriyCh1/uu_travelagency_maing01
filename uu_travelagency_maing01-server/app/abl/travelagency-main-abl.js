...
const Errors = require("../api/errors/travelagency-main-error.js");
...
const logger = LoggerFactory.get("TravelagencyMainAbl");
...
class TravelagencyMainAbl {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["travelagencyMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuTravelagency",
        typeCode: "uu-travelagency-maing01",
        location: location,
